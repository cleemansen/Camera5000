...
public class Preferences extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	private void fillPreferencesWithValues() {
		...
		/** Number of pictures */
		CheckBoxPreference infiniteCB = ((CheckBoxPreference) findPreference(this.getString(R.string.key_burstInfiniteNumber)));

		boolean infinite = infiniteCB.isChecked();
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		...
		/** infinte burst mode */
		if(key.equals(this.getString(R.string.key_burstInfiniteNumber))) {
			key = this.getString(R.string.key_burstInfiniteNumber);
			EditTextPreference etp = (EditTextPreference) findPreference(this.getString(R.string.key_burstNumberValue));
			boolean infinite = sharedPreferences.getBoolean(key, false);
			if (infinite)
				etp.setEnabled(false);
			else
				etp.setEnabled(true);
